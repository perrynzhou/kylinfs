...
typedef struct Dbservice__CreateSchemaReq Dbservice__CreateSchemaReq;
typedef struct Dbservice__CreateSchemaResp Dbservice__CreateSchemaResp;
typedef struct Dbservice__QuerySchemaReq Dbservice__QuerySchemaReq;
typedef struct Dbservice__QuerySchemaResp Dbservice__QuerySchemaResp;
typedef struct Dbservice__DropSchemaReq Dbservice__DropSchemaReq;
typedef struct Dbservice__DropSchemaResp Dbservice__DropSchemaResp;
typedef struct Dbservice__PutKvReq Dbservice__PutKvReq;
typedef struct Dbservice__PutKvResp Dbservice__PutKvResp;
typedef struct Dbservice__GetKvReq Dbservice__GetKvReq;
typedef struct Dbservice__GetKvResp Dbservice__GetKvResp;
typedef struct Dbservice__DelKvReq Dbservice__DelKvReq;
typedef struct Dbservice__DelKvResp Dbservice__DelKvResp;
...
struct  Dbservice__CreateSchemaReq
{
...
struct  Dbservice__CreateSchemaResp
{
  ProtobufCMessage base;
  char *name;
  int32_t code;
...
struct  Dbservice__QuerySchemaReq
{
  ProtobufCMessage base;
  char *name;
};
...
struct  Dbservice__QuerySchemaResp
{
  ProtobufCMessage base;
  char *name;
  int32_t code;
...
struct  Dbservice__DropSchemaReq
{
  ProtobufCMessage base;
  char *name;
};
...
struct  Dbservice__DropSchemaResp
{
  ProtobufCMessage base;
  char *name;
  int32_t code;
